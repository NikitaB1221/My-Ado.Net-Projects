...
{
    /// <inheritdoc />
    public partial class MansSeedMansProds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_main_dep = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Managers",
                columns: new[] { "Id", "Id_chief", "Id_main_dep", "Id_sec_dep", "Name", "Secname", "Surname" },
                values: new object[,]
                {
